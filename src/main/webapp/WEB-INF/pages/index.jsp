...
<body>
    ...
    <section class="home-hero">
        ...
        <div class="home-hero-image">
            ...
            <img
                src="${pageContext.request.contextPath}/images/brit.jpg"
                alt="Campus"
            />
        ...
        <div class="home-features-grid">
            ...
            <div class="home-feature-card">
                ...
                <p>
                    ...
                    Maintain rich profiles and track progress.
                </p>
            </div>
            ...
            <div class="home-feature-card">
                ...
                <p>
                    Comprehensive academic reports giving institutions clear insight
                    into student performance and progress.
                </p>
            ...
            <div class="home-feature-card">
                ...
                <p>
                    Students can easily reserve classroom slots and manage bookings
                    with admin approval workflows.
                </p>
            ...
            <div class="home-feature-card">
                ...
                <p>
                    Create, organize, and access personal academic notes anytime —
            ...
            <div class="home-feature-card">
                ...
                <p>
                    View your section's full weekly schedule with module timings,
                    organized clearly by day and time.
                </p>
        ...
        <div class="home-portals-grid">
            ...
            <a href="${pageContext.request.contextPath}/login?role=admin"
               class="home-portal-card">
                ...
                <div class="home-portal-icon">
                    <i class="ri-shield-user-line"></i>
                </div>

                <p class="home-portal-tag">
                    Administrator Access
                </p>

                <h3>Admin Dashboard</h3>

                <p class="home-portal-desc">
                    Full institutional control. Manage students, faculty,
                    courses, and generate comprehensive reports.
                </p>

                <span class="home-portal-link">
                    Enter Admin Portal
            ...
            <a href="${pageContext.request.contextPath}/login?role=student"
               class="home-portal-card">
                ...
                <p class="home-portal-desc">
                    ...
                    View schedules, create notes, book classes and
