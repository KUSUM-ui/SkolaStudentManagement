 ...
 <jsp:include page="/WEB-INF/fragments/header.jsp">
  ...
  <section class="au-hero">
    <div class="au-hero-text">
      <h2>About us</h2>
      <p>
        Skola is a smart and user-friendly student management platform designed to simplify
        ...
        connected and active student community.
      </p>
    </div>

    <div class="au-hero-image">
      <img src="${pageContext.request.contextPath}/images/abtus.png"
  ...
  <section class="au-stats">
    <div class="au-stat-item">
      ...
      <span class="au-stat-desc">
        Trusted by institutions for quality education and impactful learning.
      </span>
    </div>
    ...
    <div class="au-stat-item">
      ...
      <span class="au-stat-desc">
        A growing community of engaged learners actively developing their skills and knowledge.
      </span>
    </div>
    ...
    <div class="au-stat-item">
      ...
      <span class="au-stat-desc">
        Proven success with high effectiveness in teaching methods and student outcomes.
      </span>
    </div>
    ...
    <div class="au-stat-item">
      ...
      <span class="au-stat-desc">
        Highly rated by users for excellent content, support, and overall learning experience.
      </span>
    </div>
  </section>
  ...
  <section class="au-what">
    ...
    <p>
      Skola is a comprehensive student management system that helps students efficiently
      ...
      while also getting involved in extracurricular activities.
    </p>
  </section>
    ...
    <div class="au-team-grid">
      ...
      <c:choose>
        ...
        <c:when test="${not empty teamNames}">
          <c:forEach var="name" items="${teamNames}" varStatus="status">

            <div class="au-team-card">

              <div class="au-team-photo">
                <img src="${pageContext.request.contextPath}/images/${teamPhotos[status.index]}"
                     alt="${name}" />
              </div>

              <button class="au-team-name">${name}</button>

              <span class="au-team-role">
                ${teamRoles[status.index]}
              </span>

              <span class="au-team-desc">
                ${teamDescs[status.index]}
              </span>
