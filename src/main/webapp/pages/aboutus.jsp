  ...
  <!-- NAVBAR -->
   <nav>
        <a href="HomeServlet" class="nav-brand">
          <div class="nav-logo">
      <img src="${pageContext.request.contextPath}/resources/images/logo.png" alt="SKOLA" class="logo-img" />
	                ...
	                <c:forEach var="name" items="${teamNames}" varStatus="status">
	                    <div class="au-team-card">
	                        <div class="au-team-photo">
	                            <img src="${pageContext.request.contextPath}/resources/images/${teamPhotos[status.index]}" alt="${name}"/>
	                                 
	                        </div>
	                        <button class="au-team-name">${name}</button>
	                        <span class="au-team-role">${teamRoles[status.index]}</span>
    						<span class="au-team-desc">${teamDescs[status.index]}</span>
	                    </div>
	                </c:forEach>
	            </c:when>
	            <c:otherwise>
	                <div class="au-team-card"><div class="au-team-photo"></div><button class="au-team-name">Member 1</button></div>
	                <div class="au-team-card"><div class="au-team-photo"></div><button class="au-team-name">Member 2</button></div>
	                <div class="au-team-card"><div class="au-team-photo"></div><button class="au-team-name">Member 3</button></div>
	                <div class="au-team-card"><div class="au-team-photo"></div><button class="au-team-name">Member 4</button></div>
	                <div class="au-team-card"><div class="au-team-photo"></div><button class="au-team-name">Member 5</button></div>
	            </c:otherwise>
	        </c:choose>
	    </div>
	</section>
