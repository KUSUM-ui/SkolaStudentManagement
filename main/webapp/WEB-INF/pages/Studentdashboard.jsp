    ...
    <main class="sk-main">
        ...
        <div class="sk-row">
            ...
            <div class="sk-card sk-card-schedule">
                ...
                <p class="sk-card-title">
                    Today's schedule
                </p>

                <div class="sk-view-all">
                    View all
                </div>
            ...
            <div class="sk-card sk-card-profile">
                ...
                <span class="sk-profile-sub">
                    Computing
                </span>

                <span class="sk-profile-class">
                    ${sessionScope.student.gradeLevel}
                </span>

                <span class="sk-profile-sem">
                    Semester 4
                </span>

                <span class="sk-profile-name">
                    ...
                    <c:if test="${not empty notes}">
                        ...
                        <c:forEach var="note"
                            ...
                            <div class="sk-dash-note-item">
                                ...
                                <span class="sk-dash-note-title">
                                    ${note.title}
                                </span>

                                <span class="sk-dash-note-preview">
                                    ${note.content}
                                </span>
